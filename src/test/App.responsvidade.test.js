...
const renderApp = () => render(_jsx(ThemeProvider, { children: _jsx(BrowserRouter, { children: _jsx(App, {}) }) }));
describe('Responsividade do App', () => {
    ...
    it('deve renderizar corretamente em mobile', () => {
        ...
        if (cards.length > 0) {
            ...
            expect(screen.queryByText(/carregando/i) ||
                screen.queryByText(/não encontrado/i) ||
                screen.queryByRole('status')).toBeInTheDocument();
        }
